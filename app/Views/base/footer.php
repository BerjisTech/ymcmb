...
<script src="<?php echo base_url('assets/js/jvectormap/jquery-jvectormap-1.2.2.min.js'); ?>" id="script-resource-8"></script>
<script src="<?php echo base_url('assets/js/jvectormap/jquery-jvectormap-europe-merc-en.js'); ?>" id="script-resource-9"></script>
<script src="<?php echo base_url('assets/js/jquery.sparkline.min.js'); ?>" id="script-resource-10"></script>
<script src="<?php echo base_url('assets/js/rickshaw/vendor/d3.v3.js'); ?>" id="script-resource-11"></script>
<script src="<?php echo base_url('assets/js/rickshaw/rickshaw.min.js'); ?>" id="script-resource-12"></script>
...
<script src="<?php echo base_url('assets/js/toastr.js'); ?>" id="script-resource-15"></script>
<!-- <script src="<?php echo base_url('assets/js/neon-chat.js'); ?>" id="script-resource-16"></script> -->
